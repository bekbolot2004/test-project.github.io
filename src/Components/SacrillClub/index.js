...
const SacrillClub = () => {
  return (
    <div className='relative container mx-auto my-28'>
      <div className='flex justify-center'>
        <div className='bg-[#F5F5F5] flex items-center gap-5 px-5 py-2.5 pr-0 rounded-xl justify-center'>
          <div className='flex gap-[2px]'>
            <img src={star} className='h-4 w-4' alt='photo1' />
            <img src={star} className='h-4 w-4' alt='photo1' />
            <img src={star} className='h-4 w-4' alt='photo1' />
            <img src={star} className='h-4 w-4' alt='photo1' />
            <img src={star} className='h-4 w-4' alt='photo1' />
          ...
          <div className='flex'>
            <div className='h-[36px] w-[36px] rounded-full text-white text-[10px] font-bold border-2 border-white'><img src={img1} alt='photo1'/></div>
            <div className='h-[36px] w-[36px] rounded-full text-white text-[10px] font-bold border-2 border-white -translate-x-2.5'><img src={img2} alt='photo1'/></div>
            <div className='h-[36px] w-[36px] rounded-full text-white text-[10px] font-bold border-2 border-white -translate-x-5'><img src={img3} alt='photo1'/></div>
            <div className='h-[36px] w-[36px] rounded-full text-white text-[10px] font-bold border-2 border-white -translate-x-7'><img src={img4} alt='photo1'/></div>
      ...
      <div className='absolute top-[80px] -left-[95px] h-[260px] w-[260px] bg-cover bg-center bg-black rounded-full' > <img src={bgElement1}  alt='photo1'/> </div>
      <div className='absolute top-[470px] left-[100xpx] h-[160px] w-[160px] bg-cover bg-center bg-black rounded-full' > <img src={bgElement2} alt='photo1' /> </div>
      <div className='absolute top-[30px] -right-[40px] h-[160px] w-[160px] bg-cover bg-center bg-black rounded-full' > <img src={bgElement3}  alt='photo1'/> </div>
      <div className='absolute top-[355px] -right-[20px] h-[220px] w-[220px] bg-cover bg-center bg-black rounded-full' > <img src={bgElement4} alt='photo1' /> </div>
    </div>
  )
}
